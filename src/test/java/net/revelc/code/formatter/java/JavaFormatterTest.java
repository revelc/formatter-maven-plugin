...
class JavaFormatterTest extends AbstractFormatterTest {
    ...
    void testDoFormatFile() {
        final var expectedHash = LineEnding.LF.isSystem()
                ...
                : "736ee4fb681ff29733c7c3fe0b4f90190fcc60dd30f209c608cb2c3d370a9a7ffa8d8f005627ebfbe405d8063501d2a7b7b1919496ec346052e7eac4db81b8ef";
        final var lineEnding = LineEnding.LF.isSystem() ? LineEnding.LF : LineEnding.CRLF;
        this.twoPassTest(ImmutableMap.of(), new JavaFormatter(), "AnyClass.java", expectedHash, lineEnding);
    }
    ...
    void testDoFormatFileKeepLineFeedLF() {
        ...
        this.twoPassTest(ImmutableMap.of(), new JavaFormatter(), "AnyClassLF.java", expectedHash, LineEnding.KEEP);
    }
    ...
    void testDoFormatFileKeepLineFeedCR() {
        ...
        this.twoPassTest(ImmutableMap.of(), new JavaFormatter(), "AnyClassCR.java", expectedHash, LineEnding.KEEP);
    }
    ...
    void testDoFormatFileKeepLineFeedCRLF() {
        ...
        this.twoPassTest(ImmutableMap.of(), new JavaFormatter(), "AnyClassCRLF.java", expectedHash, LineEnding.KEEP);
    }
    ...
    void testIsInitialized() {
        ...
        javaFormatter.init(ImmutableMap.of(),
    ...
    void testDoFormatFileWithExclusions() {
        ...
        this.twoPassTest(ImmutableMap.of(), formatter, "AnyClassExclusionLF.java", expectedHash, LineEnding.KEEP);
    }
